...
const planets = [
  ...
  },
  {
    id: 'Moon',
    name: 'Lua (Moon)',
    info: 'A Lua é o único satélite natural da Terra e o quinto maior do Sistema Solar. \n É o maior satélite natural de um planeta no sistema solar em relação ao tamanho do seu corpo primário, tendo 27% do diâmetro e 60% da densidade da Terra, o que representa 1⁄81 da sua massa. ',
    age: ' 4,51 mil milhões',
    diameter: '3.474,8 km',
    temperature: ' Média: -53,1 ºC Mínima: -173,1 ºC; Máxima: 116,9 ºC'
  }
]
    ...
    return(
        ...
        {!!selectedPlanet && (
            ...
            <p>{selectedPlanet.info}</p>
                ...
                <br></br>
                <span><b>Diametro:</b>{selectedPlanet.diameter}</span>
                <br></br>
                <span><b>Temperatura:</b>{selectedPlanet.temperature}</span>
            </Card.Text>
            </Card.Body>
            </Card>
        )}
